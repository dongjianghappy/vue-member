<template>
  <span class="selectgroup">
    <select v-model="current.year"
            @change="handleclick('year')">
      <option v-for="(item, index) in yearList"
              :key="index"
              :value="item.value">{{item.name}}</option>
    </select>
    <select v-model="current.month"
            @change="handleclick('month')">
      <option v-for="(item, index) in monthList"
              :key="index"
              :value="item.value">{{item.name}}</option>
    </select>
    <select v-model="current.day"
            @change="handleclick('day')">
      <option v-for="(item, index) in dayList"
              :key="index"
              :value="item.value">{{item.name}}</option>
    </select>
  </span>
