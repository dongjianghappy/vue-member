  ...
  <div class="head-wrap w1200">
    ...
    <div class="header-content">
      ...
      <ul class="w600 right align_right">
        ...
        <li @click="handleclick('')"><img :src="loginuser.photos" class="photos p10" style="width:60px; height:60px; border-radius:50%;" /></li>
        <li>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    function init() {
      ...
      let a = true
      if (a) {
        store.dispatch('common/OtherUserInfo', {
          uid: getUid()
        })
      }
    }
    ...
    function handleclick(param: any) {
      if(param === '/activity'){
        ...
        window.location.href = `${path[1] === "app" ? "/app": ""}${url}`;
      } else {
