...
<div id="tooltip2" class="info-box" style="display: block;" :style="boxObject">
  <i :class="{'bottom-arrow-out': style.isTop, 'left-arrow-out': style.isRight, 'top-arrow-out': style.isBottom, 'right-arrow-out': style.isLeft}" :style="styleObject"></i>
  <i :class="{'bottom-arrow-in': style.isTop, 'left-arrow-in': style.isRight, 'top-arrow-in': style.isBottom, 'right-arrow-in': style.isLeft}" :style="styleObject"></i>
