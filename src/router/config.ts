...
const routes: Array<RouteRecordRaw> = [
  ...
  { path: '/graph', component: () => import('../views/graph/index.vue')},

  {
    ...
    children: [
      ...
      { path: '/u/:id/talk/', component: () => import('../views/index/talk/index.vue')},
      { path: '/u/:id/today/', component: () => import('../views/today/index.vue')},
      { path: '/u/:id/card_holder/', component: () => import('../views/cardHolder/index.vue')},
      ...
      { path: '/friend_links/', component: () => import('../views/service/friend.vue')},
      { path: '/message_board/', component: () => import('../views/service/message_board.vue')},
      { path: '/announcement/', component: () => import('../views/service/announcement/index.vue')},
      ...
      { path: '/u/:id/fish/', component: () => import('../views/application/fish/fishRecord.vue')},
      ...
      { path: '/u/:id/subscribe/', component: () => import('../views/application/subscribe/index.vue')},
      ...
      { path: '/sound/', component: () => import('../views/frontend/sound/index.vue')},
      ...
      { path: '/album', component: () => import('../views/recommend/index.vue')},
