      ...
      <div>
        <div class="col-md-3 p10">
          <div class="p15 align_center"
               @click="handleClick('identity')"
               style=" background: #f9f9f9; border-radius: 8px;">
            <div>
              <div class="mb25 inline"
                   style=" background: #eee; border-radius: 50px; width: 85px; height: 85px; line-height: 105px;">
                <i class="iconfont icon-identity"
