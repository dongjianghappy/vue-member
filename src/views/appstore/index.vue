<template>
  <div class="container w1100 clearfix">
    ...
    <div v-if="mod !== ''">
      <Article v-if="mod !=='picture' && mod !=='source'" />
      <Thumbnail v-else />
    </div>
    <div v-else>
      <div class="w180 left">
      ...
      <div class="w85 m0 right"
        ...
        <div class="module-wrap mb15"
          ...
          <div class="module-content"
            ...
            <div class="col-md-3 appstore relative"
                 v-for="(item, index) in appstore"
                 :key="index"
                 @click="handleclick(`/appstore/?mod=${item.module}`, item.grade)">
              <div class="app">
                <div class="app-img">
                  <i class="iconfont icon-grade font24 absolute"
                     style=" right: 0; bottom: 0; color:  #ccc "></i>
                  <a class="appstorebtn"
                     data-id="3"><img :src="item.image"
                         width="100%"
                         height="100%"
                         style="float:left"></a>
                </div>
        ...
        <div class="module-wrap mb15"
          ...
          <div class="module-content p0"
            ...
            <div class="media-wrap p25 bg-f9f9f9 b0"
              ...
              <div class="media-body align_left"
                ...
                <div>
                  <span class="font14"
                        style="color: #f67f00;">{{item.name}}</span>
                  <span style="color: #ccc;">({{item.description || "暂无描述"}})</span>
                  <span class="right pointer"
                        v-if="item.grade === '1'"
                        @click="handleclick(`/appstore/?mod=${item.module}`)">进入</span>
                  <span v-else
                        class="right pointer">开通</span>
...
<script lang="ts">
import { defineComponent, getCurrentInstance, computed, useStore, useRouter, useRoute, ref, onMounted } from '@/utils'
import Aside from '../home/components/Aside.vue'
import Article from "./article/index.vue"
import Thumbnail from "./thumbnail/index.vue"
import { appMenu } from '@/assets/const'
