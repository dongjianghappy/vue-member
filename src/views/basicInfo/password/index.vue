  ...
  <div class="module-content basic-info" style="height: 485px;">
    ...
    <ul class="info info-passwd">
      ...
      <li class="mb15">
        ...
        <input type="password" v-model="data.oldpassword" placeholder="旧密码" class="input-sm" style=" width:280px;">
      </li>
      <li class="mb15" style="height: auto;line-height: 12px;">
      ...
      <li>
        ...
        <input id="newpassword" type="password" v-model="data.password" placeholder="新密码" class="input-sm" style=" width:280px;">
      </li>
      <li class="mb15" style="height: auto;line-height: 12px;">
        <div class="mr10 left">密码强度</div>
        <div class="left">
      ...
      <li class="mb15">
        ...
        <input type="password" v-model="data.surepassword" placeholder="确认密码" class="input-sm" style=" width:280px;">
      </li>
      <li class="mb15" style="height: auto;line-height: 12px;">
        <div class="mr10 left">密码强度</div>
        <div class="left">
      ...
      <li class="mb15">
        ...
        <input placeholder="验证码" type="text" class="input-sm">
        <span class="pointer" style="background: #eee; padding: 0; position: absolute; left: 242px; height: 36px; line-height: 35px;"><img id="yzm" src=""></span>
      </li>
      <li>
        <label></label>
        <input type="button" value="保存修改" class="btn btn-info" @click="handleclick">
      </li>
    </ul>
  </div>
</div>
