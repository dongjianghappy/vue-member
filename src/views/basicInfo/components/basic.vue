  ...
  <div class="module-wrap">
    <div class="module-content basic-info"
      ...
      <div class="info-module">
        ...
        <div class="line"></div>
        <span data-coding=""
              class="update-info editbtn">编辑</span>
      </div>
      <ul class="info">
        <!--    <li>
                <label>ID</label>
        ...
        <li>
          <label>用户名</label>
          <div>dongjiang&nbsp;&nbsp;&nbsp;&nbsp;ID 110506372</div>
        </li>
        <li>
          <label>昵称</label>
          <div class="con">东江哥</div>
          <input type="text"
                 field="nickname"
                 value="东江哥"
                 class="input-sm">
        ...
        <li>
          <label>生日</label>
          <div class="con"><span id="year"></span>年 <span id="month"></span>月 <span id="day"></span>日</div>
        ...
        <!--    <li><label>博客地址</label>
                <div class="con"></div>
                <input type="text" field="blog" value="" class="" >
            </li>-->
        <li><label>简介</label>
          <div class="con"></div>
          <textarea field="introduction"
                    class=""></textarea>
        </li>
      </ul>
    </div>
    ...
    <div class="module-content basic-info"
      ...
      <div class="info-module">
        ...
        <div class="line"></div>
        <span class="update-info editbtn">编辑</span>
      </div>
      <ul class="info">
        <li>
          <label>邮箱</label>
          <div class="con">125772116@qq.com</div>
          <input type="text"
                 field="email"
                 value="125772116@qq.com"
                 class="input-sm">
        </li>
        <li>
          <label>电话</label>
    ...
    <div class="module-content basic-info"
      ...
      <ul class="info">
        <li>
          <label>标签</label>
          <div class="con"></div>
          <textarea field="blog_tag"
                    class=""></textarea>
        </li>
        <li>
          <label>描述</label>
          <div class="con"></div>
          <textarea field="blog_desc"
                    class=""></textarea>
        </li>
      </ul>
    </div>
