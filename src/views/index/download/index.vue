<template>
<div class="home">
  <TalkTabs :getData="init" :style="{flex: 1}" :mod="{tab: 'mod', value: 'download'}" :data="[{name: '下载我的', value: ''}, {name: '我下载的', value: 'download'}]" :query="{tab: 'item', value: route.query.item}" :render="init" />
