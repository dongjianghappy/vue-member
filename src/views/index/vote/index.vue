    ...
    <div class="module-content p20" style="min-height: 500px">
      <div class="clearfix">
        <div class="col-md-6 p10" v-for="(item, index) in dataList.list" :key="index">
          <div class="thumbnail p10 relative radius-4" style="background: var(--card-background);" @click="handleclick(item.id)">
            <div class="caption relative nowrap" style="padding: 10px 0px; height: 40px;" v-html="item.name"></div>
          </div>
        </div>
      </div>
