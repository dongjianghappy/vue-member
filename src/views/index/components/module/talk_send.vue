...
<div class="module-wrap">
  <div class="module-content send_info p0">
    ...
    <div class="send-input">
      <textarea v-model="data.summary" class="talkcontent-wrap"></textarea>
    </div>
    <v-upload ref="upload" @imgList="image" />
    <div class="operate">
      <div class="left">
        <span class="infos" @click="handleclick('expression')">
          <v-expression @onEmoji="choose" />
        </span>
        <span class="infos" @click="handleclick('upload')">
          <i class="iconfont icon-pic"></i>图片
        </span>
        <span class="infos" @click="handleclick('topic')">
