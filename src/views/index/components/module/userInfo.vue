            ...
            <div class="user-info">
                <div class="name-box">
                    <div class="mb5 font16 bold"> {{userInfo.nickname}} <span style="color: var(--color-primary)">LV.{{userInfo.level}}</span>
                        <span class="ml10" :class="userInfo.verified === '1' ? 'cl-eb7350' : 'cl-999'" @click="handleClick('verified')">V认证</span>
                        <span class="ml10" @click="handleClick('privilege')">权益</span>
                    </div>
                ...
                <ul class="name-info" v-if="module.blogger">
                    ...
                    <li><i class="iconfont icon-mood mr5" />
                        <span @click="handleStar()">星球空间</span>
                    </li>
                    <li><i class="iconfont icon-mood mr5" />
                        【{{userInfo.mood}}】
...
function handleStar(){
  store.commit("user/setIsThree", 'true')
}
</script>
