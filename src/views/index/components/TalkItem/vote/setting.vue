...
<v-dialog v-model:show="isShow" ref="dialog" title="投票设置" width="950px" :style="{width: 650, height: 600}" :hasfooter="detail.management_checked !== '1'" @submit="submit">
  <template v-slot:content v-if="isShow">
    <div style="padding: 25px; overflow: auto;" :style="{height: detail.management_checked !== '1' ? '450px' : '510px'}">
      <div class="form-wrap-box">
        ...
        <div class="li">
          ...
          <input v-model="detail.start_time" type="text" placeholder="开始时间" :disabled="detail.management_checked === '1'" class="input-sm input-150" />
          至
          <input v-model="detail.last_time" type="text" placeholder="结束时间" :disabled="detail.management_checked === '1'" class="input-sm input-150" />
        </div>
        <div class="li">
