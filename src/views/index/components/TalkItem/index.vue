        ...
        <div class="con-list" v-for="(item, index) in sourceData" :key="index">
                                    ...
                                    <ul class="font14">
                                        <template v-if="loginuser.account === item.uid">
                                            <li v-if="module.edit">
                                                ...
                                                <ScheduleDetail :data="{talk_id: item.id, id: item.schedule_id}" v-if="item.type === 'schedule'" />
                                        ...
                                        <li class="share" v-if="module.share && item.type !== 'schedule'">
            ...
            轨道示意图
                    ...
                    <div class="user_text markdown">
                        <Schedule :data="item" v-if="item.remark" />
                        <template v-else>
                            <div class="ptb15">
...
import ScheduleDetail from '../../../application/schedule/detail/detail.vue'
