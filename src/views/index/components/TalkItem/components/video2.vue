<template>
<div class="video-wrap relative" style="background: #252632; height: auto; z-index: 1; border-radius: 8px;
  ...
  <div style="position: absolute;
    ...
    <v-img :src="data.cover" v-if="!data.isplay" />
  </div>
  <div class="relative">
  ...
  <div class="ptb15 plr10" v-if="hasName">
