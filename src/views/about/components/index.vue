<template>
<v-dialog title="头像设置" width="650px" height="550px" :confirm="true" :cancel="true" @submit="submit" v-model:isShow="isShow">
  <template v-slot:content>
    <div class="layer-content pt0" style="height: 450px;">
