            ...
            <div class="music-wrap p15" style="margin: 6px; background: var(--card-background); border-radius: 8px;">
              <div class="sound-content">
                ...
                <div class="sound-info">
                  <div class="sound-title flex" style="line-height: 35px;" @click="handleRoute(item)">
                    <p class="nowrap" style="width: 170px">{{item.title}}</p>
                    <i class="iconfont icon-arrow" style="flex: 1" />
                  </div>
                  <div class="sound-tag cl-999">标签: {{item.tag || '无'}}</div>
                  <!-- <div class="sound-btn">
