  ...
  <div class="module-content p15" style="padding-bottom: 25px !important; min-height: 560px">
    <v-tabs :tabs="tabs" :isEmit="true" v-model:index="index">
      <template v-slot:extra>
        <v-condition name="日程" :defaultValue="{value: '', name: '全部'}" field="year" :enums="systemList" :render="init" />
      </template>
...
const tabs: any = [{name: "打卡记录", value: "item"}, {name: "今日打卡", value: "user"}, {name: "日期查看", value: "hot"}];
